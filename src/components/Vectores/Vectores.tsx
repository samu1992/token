    ...
    return (
        <main className="w-full absolute h-full top-0 overflow-hidden">
            <section className="absolute w-full h-full z-10">
                <div className="w-[456px] h-[456px] hidden lg:block absolute right-[-162px] bottom-[100px] rounded-[556px] border-[1px] border-solid border-[#c3d6de61]"></div>
                ...
                <div className="w-[456px] h-[456px] hidden lg:block absolute left-[-250px] bottom-[80px] rounded-[556px] border-[1px] border-solid border-[#c3d6de61]"></div>

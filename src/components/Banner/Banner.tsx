...
export default function Banner() {
    return (
        <section className="gap-16 relative top-0 flex flex-col items-end justify-end pt-4 md:pt-8 lg:pt-12 xl:pt-40 pb-10 lg:pb-16 px-[50px] sm:px-[100px] w-full h-[100vh]">
